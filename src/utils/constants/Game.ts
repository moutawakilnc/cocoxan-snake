...
export const MOVEMENT_KEY_to_DIR = {
	[MOUVEMENT_KEY.arrowUp]: MOUVEMENT_DIRECTION.arrowUp,
	[MOUVEMENT_KEY.arrowDown]: MOUVEMENT_DIRECTION.arrowDown,
	[MOUVEMENT_KEY.arrowRight]: MOUVEMENT_DIRECTION.arrowRight,
	[MOUVEMENT_KEY.arrowLeft]: MOUVEMENT_DIRECTION.arrowLeft,
	[MOUVEMENT_KEY.none]: MOUVEMENT_DIRECTION.none,
};
